...
import com.stayflow.backend.domain.user.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/apartments/{id}/availability").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/apartments/{id}/booked-dates").permitAll()
